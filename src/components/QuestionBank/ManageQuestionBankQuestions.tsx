...
import { DifficultyLevel, PaginationParams, Question, QuestionType } from '../../types';
...
export const ManageQuestionBankQuestions: React.FC<Props> = ({ bankId, onQuestionsChange }) => {
		...
		<>
						...
						{selectedRowKeys.length > 0 && (
							...
							>
								<Button danger icon={<DeleteOutlined />}>
									{t('manageQuestionBankQuestions.removeBtn', {
										count: selectedRowKeys.length,
									})}
								</Button>
							</Popconfirm>
			...
			>
				<Space direction="vertical" size="middle" style={{ width: '100%', marginTop: 16 }}>
					...
					{questions.length > 0 && (
						<Alert
							message={t('manageQuestionBankQuestions.filterInfo', {
					...
					<Space>
						...
						{fetchingQuestions && (
							<Text type="secondary">{t('manageQuestionBankQuestions.loading')}</Text>
						)}
					</Space>

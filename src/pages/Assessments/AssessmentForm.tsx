		...
		<Space direction="vertical" size="large" style={{ width: "100%" }}>
			<Row justify="space-between" align="middle">
				<Col>
					<Title level={2}>
						{isEdit
							? t("assessmentForm.editTitle")
							: t("assessmentForm.createTitle")}
					</Title>
				</Col>
				<Col>
					<Button
			...
			>
				<Card
					title={t("assessmentForm.basicInfo.title")}
				...
				>
					<Row gutter={16}>
						<Col xs={24}>
							<Form.Item
								label={t(
									"assessmentForm.basicInfo.assessmentTitle",
								)}
								name="title"
								rules={[
									{
										required: true,
										message: t(
											"assessmentForm.basicInfo.titleRequired",
										),
									},
									{
										max: 200,
										message: t(
											"assessmentForm.basicInfo.titleMaxLength",
										),
									},
								]}
							>
								<Input
									placeholder={t(
										"assessmentForm.basicInfo.titlePlaceholder",
									)}
									size="large"
								/>
							</Form.Item>
						...
						<Col xs={24}>
							<Form.Item
								label={t(
									"assessmentForm.basicInfo.description",
								)}
								name="description"
								rules={[
									{
										max: 1000,
										message: t(
											"assessmentForm.basicInfo.descriptionMaxLength",
										),
									},
								]}
							>
					...
					<Row gutter={16}>
								...
								rules={[
									{
										required: true,
										message: t(
											"assessmentForm.basicInfo.durationRequired",
										),
									},
								]}
							>
						...
						<Col xs={24} sm={12} lg={6}>
							<Form.Item
								label={t(
									"assessmentForm.basicInfo.passingScore",
								)}
								name="passing_score"
								rules={[
									{
										required: true,
										message: t(
											"assessmentForm.basicInfo.passingScoreRequired",
										),
									},
								]}
							>
						...
						<Col xs={24} sm={12} lg={6}>
							<Form.Item
								label={t(
									"assessmentForm.basicInfo.maxAttempts",
								)}
								name="max_attempts"
								tooltip={t(
									"assessmentForm.basicInfo.maxAttemptsTooltip",
								)}
							>
								<InputNumber
									min={1}
						...
						<Col xs={24} sm={12} lg={6}>
							<Form.Item
								label={t(
									"assessmentForm.basicInfo.timeWarning",
								)}
								name="time_warning"
								tooltip={t(
									"assessmentForm.basicInfo.timeWarningTooltip",
								)}
							>
								<InputNumber
									min={60}
						...
						<Col xs={24} sm={12}>
							...
							>
								<DatePicker
									...
									style={{ width: "100%" }}
									placeholder={t(
										"assessmentForm.basicInfo.dueDatePlaceholder",
									)}
								/>
							</Form.Item>
						</Col>
				...
				>
					<Row gutter={[16, 16]}>
						<Col xs={24} sm={12} lg={8}>
							<Form.Item
								label={t(
									"assessmentForm.displaySettings.randomizeQuestions",
								)}
						...
						<Col xs={24} sm={12} lg={8}>
							<Form.Item
								label={t(
									"assessmentForm.displaySettings.randomizeOptions",
								)}
						...
						<Col xs={24} sm={12} lg={8}>
							<Form.Item
								label={t(
									"assessmentForm.displaySettings.showProgressBar",
								)}
					...
					<Row gutter={[16, 16]}>
						<Col xs={24} sm={12} lg={8}>
							<Form.Item
								label={t(
									"assessmentForm.displaySettings.timeLimitEnforced",
								)}
						...
						<Col xs={24} sm={12} lg={8}>
							<Form.Item
								label={t(
									"assessmentForm.displaySettings.autoSubmitOnTimeout",
								)}
				...
				<Card
					title={t("assessmentForm.proctoring.title")}
					style={{ marginBottom: 16 }}
				>
					<Row gutter={[16, 16]}>
						<Col xs={24} sm={12} lg={8}>
							<Form.Item
								label={t(
									"assessmentForm.proctoring.requireWebcam",
								)}
						...
						<Col xs={24} sm={12} lg={8}>
							<Form.Item
								label={t(
									"assessmentForm.proctoring.preventTabSwitching",
								)}
						...
						<Col xs={24} sm={12} lg={8}>
							<Form.Item
								label={t(
									"assessmentForm.proctoring.preventRightClick",
								)}
						...
						<Col xs={24} sm={12} lg={8}>
							<Form.Item
								label={t(
									"assessmentForm.proctoring.preventCopyPaste",
								)}
						...
						<Col xs={24} sm={12} lg={8}>
							<Form.Item
								label={t(
									"assessmentForm.proctoring.requireFullScreen",
								)}
						...
						<Col xs={24} sm={12} lg={8}>
							<Form.Item
								label={t(
									"assessmentForm.proctoring.requireIdentityVerification",
								)}
								name={[
									"settings",
				...
				<Card
					title={t("assessmentForm.accessibility.title")}
					style={{ marginBottom: 16 }}
				>
					<Row gutter={[16, 16]}>
						<Col xs={24} sm={12} lg={8}>
							<Form.Item
								label={t(
									"assessmentForm.accessibility.allowScreenReader",
								)}
						...
						<Col xs={24} sm={12} lg={8}>
							<Form.Item
								label={t(
									"assessmentForm.accessibility.highContrastMode",
								)}
						...
						<Col xs={24} sm={12} lg={8}>
							<Form.Item
								label={t(
									"assessmentForm.accessibility.fontSizeAdjustment",
								)}
								name={["settings", "font_size_adjustment"]}
								tooltip={t(
									"assessmentForm.accessibility.fontSizeTooltip",
								)}
							>
								<InputNumber
									min={-2}

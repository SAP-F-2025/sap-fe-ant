				...
				shortcuts: [
					{
						keys: ["←", "→"],
						descriptionKey:
							"shortcuts.descriptions.prevNextQuestion",
					},
					{
						keys: ["Shift", "Enter"],
					...
					},
					{
						keys: ["Ctrl", "Enter"],
						descriptionKey:
							"shortcuts.descriptions.openSubmitDialog",
					},
					{
					...
					},
					{
						keys: ["Ctrl", "/"],
						descriptionKey:
							"shortcuts.descriptions.toggleShortcuts",
					},
				],
			},
			{
			...
			},
			{
				...
				shortcuts: [
					...
					},
					{
						keys: ["Alt", "↑/↓"],
						descriptionKey:
							"shortcuts.descriptions.moveSelectedOrNavigate",
					},
					{
						keys: ["1", "9"],
						descriptionKey:
							"shortcuts.descriptions.quickSelectOrMove",
					},
				],
			},
		],
...
const ShortcutsModalComponent = React.forwardRef<

...
import { CreateInviteCodeRequest, CreateInviteLinkRequest, GroupInviteResponse, GroupMemberRole, InviteType } from '../../types';
...
const InviteManagementTab: React.FC<InviteManagementTabProps> = ({ groupId, canManage }) => {
    ...
    const copyToClipboard = (text: string, type: 'link' | 'code') => {
        ...
        message.success(type === 'link' ? t('groups.invite.linkCopied') : t('groups.invite.codeCopied'));
    };
            ...
            >
                {selectedInvite && (
                    <Flex vertical align="center" gap={16}>
                        <QRCode
                            value={getInviteUrl(selectedInvite)}
                            size={256}
                            errorLevel="M"
                        />
                        <Text

	...
	return (
		(function (t, e) {
			...
			for (;;) {
				...
				(e((t << 2) | (r >> 4)),
					64 != i &&
						(e(((r << 4) & 240) | (i >> 2)), 64 != s && e(((i << 6) & 192) | s)));
			}
		})(t, function (t) {
			r[i++] = t;
		}),
...
function he(t) {
	return null == t
		? t
		: 'bigint' == typeof t
			? (bt(t) ? (t = Number(t)) : ((t = Ht(64, t)), (t = bt(t) ? Number(t) : String(t))), t)
			: Qt(t)
				? 'number' == typeof t
					? se(t)
					: oe(t)
...
var Ae = class extends Ee {
	...
	La() {
		var t = Ce;
		if (0 !== this.size)
			return Array.from(super.entries(), (e) => ((e[0] = t(e[0])), (e[1] = t(e[1])), e));
	}
	da(t = ke) {
		const e = [],
			n = super.entries();
	...
	Ja(t) {
		...
		((t = t[1]),
			(t = this.I ? (void 0 === t ? null : t) : this.X(t, !1, !0, void 0, !1, this.M)),
			super.set(e, t));
	}
	has(t) {
	...
	get(t) {
		...
		if (void 0 !== e) {
			var n = this.I;
			return n
				? ((n = this.X(e, !1, !0, n, this.pa, this.M)) !== e && super.set(t, n), n)
				: e;
		}
	}
	[Symbol.iterator]() {
	...
	if ((e = t.length) && !(512 & n)) {
		...
		if ((r && (t[e] = void 0), s < o && r)) {
			for (var a in ((s = !0), r)) {
				const c = +a;
				c <= o
					? ((t[(i = c + n)] = r[a]), (e = Math.max(i + 1, e)), (i = !1), delete r[a])
					: (s = !1);
			}
			s && (r = void 0);
		}
...
function Ne(t, e, n, r) {
	if (null == t) {
		var i = 96;
		(n ? ((t = [n]), (i |= 512)) : (t = []), e && (i = (-16760833 & i) | ((1023 & e) << 14)));
	} else {
...
function un(t, e, n, r, i, s, o) {
	...
	if (o && !(8 & h || (!i.length && (1 === c || (4 === c && 32 & h))))) {
		for (
			Ze(h) && ((i = ct(i)), (h = pn(h, e)), (e = We(t, e, r, i))), n = i, o = h, u = 0;
			u < n.length;
			u++
		)
			(h = n[u]) !== (l = je(h)) && (n[u] = l);
	...
	return (
		1 === c || (4 === c && 32 & h)
			? Ze(h) ||
				((e = h),
				(h |= !i.length || (16 & h && (!a || 32 & h)) ? 2 : 1024) !== e && rt(i, h),
				Object.freeze(i))
			: (2 === c &&
					Ze(h) &&
					(rt((i = ct(i)), (h = gn((h = pn(h, e)), e, s))), (e = We(t, e, r, i))),
...
function bn(t, e, n) {
	{
		...
		if ((pt(a), null == n)) We(o, a, e);
			...
			for (
				i || (t = 0),
					s || ((n = ct(n)), (r = 0), (t = gn((t = pn(t, a)), a, !0)), (s = !1)),
					t |= 21,
					i = 0;
				i < n.length;
				i++
			...
			(t !== r && (s && ((n = ct(n)), (t = gn((t = pn(t, a)), a, !0))), rt(n, t)),
				We(o, a, e, n));
		}
	}
}
...
function Ln(t) {
	...
	if (t instanceof Uint8Array)
		return { buffer: new Uint8Array(t.buffer, t.byteOffset, t.byteLength), O: !1 };
	throw Error(
...
function Pr(t, e, n, r) {
	...
	for (c = 1; void 0 !== s; ) {
		...
		for (
			u = c + 1, 'number' == typeof (s = r[++o]) && s < 0 && ((u -= s), (s = r[++o]));
			c < u;
			c++
		) {
			const r = a[c];
			...
			: (t, e) => {
					...
					for (; jn(e) && 4 != e.h; ) {
						...
						(null != s && s(e, t, i)) ||
							((i = (s = e).l),
							Vn(s),
							s.fa ? (s = void 0) : ((o = s.g.g - i), (s.g.g = i), (s = Bn(s.g, o))),
							(i = t),
			...
			switch ((ar(t, n, 0), typeof e)) {
				...
				case 'bigint':
					((n = BigInt.asUintN(64, e)),
						(n = new tr(Number(n & BigInt(4294967295)), Number(n >> BigInt(32)))),
						nr(t.g, n.h, n.g));
					break;
				default:
...
function ti(t, e, n) {
	(null == e || 'string' == typeof e || e instanceof N || (C(e) ? C(e) && H(Z) : (e = void 0)),
		null != e && ur(t, n, Ln(e).buffer));
}
function ei(t, e, n) {
	return (
		(5 === t.h || 2 === t.h) &&
		((e = en(e, 0 | e[Q], n, !1)), 2 == t.h ? zn(t, Cn, e) : e.push(Cn(t.g)), !0)
	);
}
var ni = Wr(
		function (t, e, n) {
	...
	ui = zr(
		function (t, e, n) {
			return (
				(0 === t.h || 2 === t.h) &&
				((e = en(e, 0 | e[Q], n, !1)), 2 == t.h ? zn(t, In, e) : e.push(In(t.g)), !0)
			);
		},
		function (t, e, n) {
	...
	yi = (function (t, e, n = fr) {
		...
		function (t, e, n, r, i) {
			return (
				2 === t.h &&
				((r = De(void 0, r, !0)), en(e, 0 | e[Q], n, !0).push(r), Xn(t, r, i), !0)
			);
		},
		function (t, e, n, r, i) {
	...
	Ei = zr(
		function (t, e, n) {
			return (
				(0 === t.h || 2 === t.h) &&
				((e = en(e, 0 | e[Q], n, !1)), 2 == t.h ? zn(t, Mn, e) : e.push(Mn(t.g)), !0)
			);
		},
		function (t, e, n) {
			if (null != (e = Hr(ee, e)))
	...
	Oi = [
		...
		zr(
			function (t, e, n) {
				return (
					(0 === t.h || 2 === t.h) &&
					((e = en(e, 0 | e[Q], n, !1)), 2 == t.h ? zn(t, On, e) : e.push(In(t.g)), !0)
				);
			},
			function (t, e, n) {
				if (null != (e = Hr(te, e)) && e.length) {
...
function ko(t, e) {
	return (
		...
		void 0 !== t.maxResults ? Tn(e, 2, t.maxResults) : 'maxResults' in t && He(e, 2),
...
function Lo(t) {
	...
	for (const n of ln(t, ds, 1))
		e.push({ x: En(n, 1) ?? 0, y: En(n, 2) ?? 0, z: En(n, 3) ?? 0, visibility: En(n, 4) ?? 0 });
	return e;
}
function Ro(t) {
	const e = [];
...
function Ko(t) {
	try {
		...
		if (e > 1)
			throw Error('Encountered multiple errors: ' + t.G.map((t) => t.message).join(', '));
	} finally {
		t.G = [];
	}
}
...
function ia(t, e, n, r) {
	return (
		ra(t, e),
		t.h || (t.m(), t.C()),
		n ? (t.s || (t.s = na(t, !0)), (n = t.s)) : (t.v || (t.v = na(t, !1)), (n = t.v)),
		e.useProgram(t.h),
		n.bind(),
		t.l(),
		(t = r()),
...
var ha = class extends ca {
		...
		m() {
			super.m();
			const t = this.g;
			((this.L = Qo(t.getUniformLocation(this.h, 'backgroundTexture'), 'Uniform location')),
				(this.U = Qo(
					t.getUniformLocation(this.h, 'colorMappingTexture'),
					'Uniform location'
				)),
				(this.K = Qo(t.getUniformLocation(this.h, 'maskTexture'), 'Uniform location')));
		}
		l() {
			super.l();
			const t = this.g;
	...
	ua = class extends ca {
		...
		m() {
			super.m();
			const t = this.g;
			((this.K = Qo(t.getUniformLocation(this.h, 'defaultTexture'), 'Uniform location')),
				(this.L = Qo(t.getUniformLocation(this.h, 'overlayTexture'), 'Uniform location')),
				(this.H = Qo(t.getUniformLocation(this.h, 'maskTexture'), 'Uniform location')));
		}
		l() {
			super.l();
			const t = this.g;
...
function ya(t) {
	...
	let n = la(t, 2);
	return (
		n || ((n = sa(ma(t), e, t.m ? e.LINEAR : e.NEAREST)), t.g.push(n), (t.j = !0)),
...
var va,
	Ea = class {
		...
		ia() {
			return (
				(e = la((t = this), 0)) ||
					((e = da(t)), (e = new Uint8Array(e.map((t) => 255 * t))), t.g.push(e)),
				e
			);
			var t, e;
		}
...
function La(t, e, n) {
	if (e.R()) n(e.N());
		...
		t.m = t.m ?? new ca();
		const i = xa(t);
		(n((t = new Ea([r], e.m, !1, i.canvas, t.m, e.width, e.height)).N()), t.close());
	}
}
function Ra(t, e, n, r) {
	const i = (function (t) {
...
var Ia = class {
	constructor(t, e) {
		('undefined' != typeof CanvasRenderingContext2D && t instanceof CanvasRenderingContext2D) ||
	...
	ta(t, e, n = [0, 0, 0, 255]) {
		this.l
			? (function (t, e, n, r) {
					...
					La(t, e, (e) => {
						(Ra(t, e, n, r),
							(e = Sa(t)).drawImage(i.canvas, 0, 0, e.canvas.width, e.canvas.height));
					});
				})(this, t, n, e)
			: Ra(this, t.N(), n, e);
	}
...
var Ga = class {
	...
	za() {
		var t = Ma(this, 1);
		return (
			t || (Ca(this), Da(this), (t = Ba(this)), Na(this), this.g.push(t), (this.j = !0)),
			t
		);
	}
	N() {
...
var Za = class extends Ja {
	...
	o(t) {
		return (
			'minDetectionConfidence' in t && An(this.h, 2, t.minDetectionConfidence ?? 0.5),
			'minSuppressionThreshold' in t && An(this.h, 3, t.minSuppressionThreshold ?? 0.3),
			this.l(t)
		);
	}
	D(t, e) {
...
var uc = class extends Ja {
	...
	o(t) {
		return (
			...
			'minFaceDetectionConfidence' in t && An(this.s, 2, t.minFaceDetectionConfidence ?? 0.5),
			'minTrackingConfidence' in t && An(this.h, 4, t.minTrackingConfidence ?? 0.5),
			'minFacePresenceConfidence' in t && An(this.v, 2, t.minFacePresenceConfidence ?? 0.5),
...
var lc = class extends Ja {
	...
	Ka(t, e, n) {
		...
		if (((this.h = 'function' == typeof e ? e : n), Ya(this, t, r ?? {}), !this.h))
			return this.s;
	}
	m() {
		var t = new Qi();
...
var mc = class extends Ja {
	...
	o(t) {
		if (
			...
			'minHandDetectionConfidence' in t && An(this.v, 2, t.minHandDetectionConfidence ?? 0.5),
			'minTrackingConfidence' in t && An(this.s, 4, t.minTrackingConfidence ?? 0.5),
			'minHandPresenceConfidence' in t && An(this.C, 2, t.minHandPresenceConfidence ?? 0.5),
		...
		return (
			t.customGesturesClassifierOptions
				? (dn(
					...
					dn(this.h, 0, 4, e))
				: void 0 === t.customGesturesClassifierOptions && hn(this.h, Ws, 4)?.g(),
			this.l(t)
		);
	}
	Fa(t, e) {
...
var _c = class extends Ja {
	...
	o(t) {
		return (
			...
			'minHandDetectionConfidence' in t && An(this.j, 2, t.minHandDetectionConfidence ?? 0.5),
			'minTrackingConfidence' in t && An(this.h, 4, t.minTrackingConfidence ?? 0.5),
			'minHandPresenceConfidence' in t && An(this.s, 2, t.minHandPresenceConfidence ?? 0.5),
			this.l(t)
		);
	}
	D(t, e) {
...
var Ac = class extends Ja {
	...
	o(t) {
		return (
			...
			'minFacePresenceConfidence' in t && An(this.H, 2, t.minFacePresenceConfidence ?? 0.5),
			'outputFaceBlendshapes' in t &&
				(this.outputFaceBlendshapes = !!t.outputFaceBlendshapes),
			'minPoseDetectionConfidence' in t && An(this.v, 2, t.minPoseDetectionConfidence ?? 0.5),
			'minPoseSuppressionThreshold' in t &&
				An(this.v, 3, t.minPoseSuppressionThreshold ?? 0.3),
			'minPosePresenceConfidence' in t && An(this.L, 2, t.minPosePresenceConfidence ?? 0.5),
			'outputPoseSegmentationMasks' in t &&
				(this.outputPoseSegmentationMasks = !!t.outputPoseSegmentationMasks),
			'minHandLandmarksConfidence' in t && An(this.K, 2, t.minHandLandmarksConfidence ?? 0.5),
			this.l(t)
		);
	}
	D(t, e, n) {
	...
	m() {
		...
		const r = new zi();
		(Xi(r, 'mediapipe.tasks.vision.holistic_landmarker.HolisticLandmarkerGraph'),
			yn(r, 8, xi, n),
			...
			this.outputPoseSegmentationMasks &&
				...
				this.g.V('pose_segmentation_mask', (t, e) => {
					((this.h.poseSegmentationMasks = [qa(this, t, !0, !this.C)]), Yo(this, e));
				}),
...
var kc = class extends Ja {
	...
	o(t) {
		...
		return (
			(n = n ? n.clone() : new Ss()),
			void 0 !== t.l2Normalize ? wn(n, 1, t.l2Normalize) : 'l2Normalize' in t && He(n, 1),
			void 0 !== t.quantize ? wn(n, 2, t.quantize) : 'quantize' in t && He(n, 2),
			dn(e, 0, 2, n),
			this.l(t)
		);
	}
	...
	J() {
		!(function (t) {
			const e = ln(t.ca(), zi, 1).filter((t) =>
				(vn(t, 1) ?? '').includes('mediapipe.tasks.TensorsToSegmentationCalculator')
			);
			if (((t.s = []), e.length > 1))
				throw Error(
...
var Vc = class extends Ja {
	...
	segment(t, e, n, r) {
		...
		if (e.keypoint) {
			...
			for (a of ((o = new Nc()), e.scribble))
				(wn((e = new Uc()), 3, !0), An(e, 1, a.x), An(e, 2, a.y), yn(o, 1, Uc, e));
			fn(s, 15, Gc, o);
		}
		(yn(r, 1, Bc, s),
	...
	m() {
		...
		Yn(e, Eo, this.h);
		const n = new zi();
		(Xi(n, 'mediapipe.tasks.vision.interactive_segmenter.InteractiveSegmenterGraph'),
			Hi(n, 'IMAGE:image_in'),
			Hi(n, 'ROI:roi_in'),
			Hi(n, 'NORM_RECT:norm_rect_in'),
			n.o(e),
...
var Kc = class extends Ja {
	...
	o(t) {
		return (
			...
			'minPoseDetectionConfidence' in t && An(this.j, 2, t.minPoseDetectionConfidence ?? 0.5),
			'minTrackingConfidence' in t && An(this.h, 4, t.minTrackingConfidence ?? 0.5),
			'minPosePresenceConfidence' in t && An(this.v, 2, t.minPosePresenceConfidence ?? 0.5),
...
//# sourceMappingURL=/sm/8efb985e961a4bb934a0b106867af69f73a3684dafbff85b489b80a9ffb59b9f.map

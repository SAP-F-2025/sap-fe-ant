	...
	const renderQuestionTypeContent = () => {
		switch (questionType) {
			case QuestionType.MultipleChoice:
				return (
					<Card
						title={t("questionForm.multipleChoice.title")}
						type="inner"
					>
						<Space
							direction="vertical"
						...
						>
								...
								{(fields, { add, remove }) => (
									<>
										...
										<Form.Item>
											...
											>
												{t(
													"questionForm.multipleChoice.addOption",
												)}
											</Button>
										</Form.Item>
									</>
							...
							<Form.Item
								...
								shouldUpdate={(prevValues, currentValues) =>
									prevValues.content?.options !==
									currentValues.content?.options
								}
							>
								{({ getFieldValue }) => {
									const options =
										getFieldValue(["content", "options"]) ||
										[];
									return (
										<Form.Item
											label={t(
												"questionForm.multipleChoice.correctAnswer",
											)}
											name={[
												"content",
												"correct_answers",
							...
							<Card
								title={t(
									"questionForm.multipleChoice.settings",
								)}
								type="inner"
								size="small"
							>
								<Row gutter={[16, 16]}>
									<Col span={8}>
										...
										>
											<Checkbox>
												{t(
													"questionForm.multipleChoice.allowMultiple",
												)}
											</Checkbox>
										</Form.Item>
									</Col>
									<Col span={8}>
										...
										>
											<Checkbox>
												{t(
													"questionForm.multipleChoice.randomizeOptions",
												)}
											</Checkbox>
										</Form.Item>
									</Col>
									<Col span={8}>
										...
										>
											<Checkbox>
												{t(
													"questionForm.multipleChoice.partialCredit",
												)}
											</Checkbox>
										</Form.Item>
									</Col>
			...
			case QuestionType.TrueFalse:
				return (
					<Card
						title={t("questionForm.trueFalse.title")}
						type="inner"
					>
						<Space
							direction="vertical"
						...
						>
							...
							<Form.Item
								label={t(
									"questionForm.trueFalse.correctAnswer",
								)}
								...
								rules={[
									{
										required: true,
										message: t(
											"questionForm.trueFalse.selectCorrectAnswer",
										),
									},
								]}
							>
								<Radio.Group>
									<Radio value={true}>
										{t("questionForm.trueFalse.true")}
									</Radio>
									<Radio value={false}>
										{t("questionForm.trueFalse.false")}
									</Radio>
								</Radio.Group>
							</Form.Item>
							...
							>
								<Row gutter={16}>
									<Col span={12}>
										<Form.Item
											label={t(
												"questionForm.trueFalse.trueLabel",
											)}
											name={["content", "true_label"]}
											tooltip={t(
												"questionForm.trueFalse.trueLabelTooltip",
											)}
										>
											<Input
												placeholder={t(
									...
									<Col span={12}>
										<Form.Item
											label={t(
												"questionForm.trueFalse.falseLabel",
											)}
											name={["content", "false_label"]}
											tooltip={t(
												"questionForm.trueFalse.falseLabelTooltip",
											)}
										>
											<Input
												placeholder={t(
					...
					<Card title={t("questionForm.essay.title")} type="inner">
						...
						>
							...
							<Form.Item
								...
								tooltip={t(
									"questionForm.essay.suggestedLengthTooltip",
								)}
							>
								<Input
									placeholder={t(
										"questionForm.essay.suggestedLengthPlaceholder",
									)}
								/>
							</Form.Item>
							...
							>
								<Form.Item
									label={t(
										"questionForm.essay.rubricCriteriaLabel",
									)}
									name={["content", "rubric_criteria"]}
									tooltip={t(
										"questionForm.essay.rubricCriteriaTooltip",
									)}
								>
									<Select
										mode="tags"
							...
							<Form.Item
								...
								tooltip={t(
									"questionForm.essay.sampleAnswerTooltip",
								)}
							>
								<TextArea
									rows={6}
									placeholder={t(
										"questionForm.essay.sampleAnswerPlaceholder",
									)}
								/>
							</Form.Item>
							...
							<Card
								title={t(
									"questionForm.essay.autoGradeSettings",
								)}
								type="inner"
								size="small"
							>
								...
								>
									...
									>
										<Checkbox>
											{t(
												"questionForm.essay.enableAutoGrade",
											)}
										</Checkbox>
									</Form.Item>
							...
							<Alert
								...
								description={t(
									"questionForm.essay.autoGradeNoteDesc",
								)}
								type="warning"
								showIcon
							/>
			...
			case QuestionType.FillBlank:
				return (
					<Card
						title={t("questionForm.fillBlank.title")}
						type="inner"
					>
						<Form.Item
							...
							rules={[
								{
									required: true,
									message: t(
										"questionForm.fillBlank.templateRequired",
									),
								},
							]}
							tooltip={t(
								"questionForm.fillBlank.templateTooltip",
							)}
						>
							<TextArea
								rows={3}
								placeholder={t(
									"questionForm.fillBlank.templatePlaceholder",
								)}
								showCount
							/>
						</Form.Item>
						...
						<Row gutter={16}>
							<Col span={12}>
								<Form.Item
									label={t(
										"questionForm.fillBlank.caseSensitive",
									)}
								...
								>
									<Checkbox>
										{t(
											"questionForm.fillBlank.caseSensitiveLabel",
										)}
									</Checkbox>
								</Form.Item>
							</Col>
							<Col span={12}>
								<Form.Item
									label={t(
										"questionForm.fillBlank.trimSpaces",
									)}
								...
								>
									<Checkbox>
										{t(
											"questionForm.fillBlank.trimSpacesLabel",
										)}
									</Checkbox>
								</Form.Item>
							</Col>
						...
						<Divider>
							{t("questionForm.fillBlank.blankConfig")}
						</Divider>

						<Form.Item
							noStyle
							shouldUpdate={(prevValues, currentValues) =>
								prevValues.content?.template !==
								currentValues.content?.template
							}
						>
							{({ getFieldValue }) => {
								const template =
									getFieldValue(["content", "template"]) ||
									"";
								const blankMatches =
									template.match(/\{blank\d+\}/g) || [];
									...
									<>
										{uniqueBlanks.length > 0 ? (
											...
											<Typography.Text type="secondary">
												{t(
													"questionForm.fillBlank.templateHint",
												)}
											</Typography.Text>
										)}
									</>
									...
									{(fields, { add, remove }) => (
										<>
											...
											<Form.Item>
												...
												>
													{t(
														"questionForm.matching.addLeftItem",
													)}
												</Button>
											</Form.Item>
										</>
									...
									{(fields, { add, remove }) => (
										<>
											...
											<Form.Item>
												...
												>
													{t(
														"questionForm.matching.addRightItem",
													)}
												</Button>
											</Form.Item>
										</>
								...
								<Row gutter={16}>
									<Col span={8}>
										...
										>
											<Checkbox>
												{t(
													"questionForm.matching.randomizeLeft",
												)}
											</Checkbox>
										</Form.Item>
									</Col>
									<Col span={8}>
										...
										>
											<Checkbox>
												{t(
													"questionForm.matching.randomizeRight",
												)}
											</Checkbox>
										</Form.Item>
									</Col>
									<Col span={8}>
										...
										>
											<Checkbox>
												{t(
													"questionForm.matching.partialCredit",
												)}
											</Checkbox>
										</Form.Item>
									</Col>
								...
								<Row gutter={16}>
									<Col span={12}>
										...
										>
											<Checkbox>
												{t(
													"questionForm.ordering.randomizeInitial",
												)}
											</Checkbox>
										</Form.Item>
									</Col>
									<Col span={12}>
										...
										>
											<Checkbox>
												{t(
													"questionForm.ordering.partialCredit",
												)}
											</Checkbox>
										</Form.Item>
									</Col>
			...
			case QuestionType.ShortAnswer:
				return (
					<Card
						title={t("questionForm.shortAnswer.title")}
						type="inner"
					>
						<Space
							direction="vertical"
						...
						>
							...
							<Form.Item
								label={t(
									"questionForm.shortAnswer.acceptedAnswers",
								)}
								...
								tooltip={t(
									"questionForm.shortAnswer.acceptedAnswersTooltip",
								)}
							>
								<Select
									mode="tags"
							...
							<Form.Item
								label={t(
									"questionForm.shortAnswer.placeholderText",
								)}
								...
								rules={[
									{
										required: true,
										message: t(
											"questionForm.shortAnswer.maxLengthRequired",
										),
									},
									{
										type: "number",
										...
										max: 500,
										message: t(
											"questionForm.shortAnswer.maxLengthRange",
										),
									},
								]}
							>
								<InputNumber
									...
									style={{ width: "100%" }}
									placeholder={t(
										"questionForm.shortAnswer.maxLengthPlaceholder",
									)}
								/>
							</Form.Item>
							...
							<Card
								title={t(
									"questionForm.shortAnswer.matchingSettings",
								)}
								type="inner"
								size="small"
							>
								<Row gutter={[16, 16]}>
									<Col span={8}>
										...
										>
											<Checkbox>
												{t(
													"questionForm.shortAnswer.caseSensitive",
												)}
											</Checkbox>
										</Form.Item>
									</Col>
									<Col span={8}>
										...
										>
											<Checkbox>
												{t(
													"questionForm.shortAnswer.exactMatch",
												)}
											</Checkbox>
										</Form.Item>
									</Col>
									<Col span={8}>
										...
										>
											<Checkbox>
												{t(
													"questionForm.shortAnswer.fuzzyMatching",
												)}
											</Checkbox>
										</Form.Item>
									</Col>
							...
							<Alert
								message={t(
									"questionForm.shortAnswer.matchingNote",
								)}
								description={
									<ul
										style={{
									...
									>
										<li>
											{t(
												"questionForm.shortAnswer.matchingNoteDesc1",
											)}
										</li>
										<li>
											{t(
												"questionForm.shortAnswer.matchingNoteDesc2",
											)}
										</li>
										<li>
											{t(
												"questionForm.shortAnswer.matchingNoteDesc3",
											)}
										</li>
									</ul>
								}
			...
			>
				<Card title={t("questionForm.basicInfo")}>
								...
								rules={[
									{
										required: true,
										message: t(
											"questionForm.selectQuestionType",
										),
									},
								]}
							>
					...
					>
						<TextArea
							rows={3}
							placeholder={t(
								"questionForm.explanationPlaceholder",
							)}
							showCount
						/>
					</Form.Item>
				...
				<Form.Item>
					<Space>
						...
						>
							{isEdit
								? t("questionForm.updateBtn")
								: t("questionForm.createBtn")}
						</Button>
						<Button
							onClick={() => navigate("/questions")}
							size="large"

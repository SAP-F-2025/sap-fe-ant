import { LoginOutlined, RocketOutlined, SafetyOutlined, ThunderboltOutlined } from '@ant-design/icons';
				...
				<div style={{
					...
					<div style={{
						...
						<div style={{ textAlign: 'center', marginBottom: 40 }}>
							<Title level={2} style={{ color: 'white', marginBottom: 8, fontSize: 32 }}>{t('login.welcomeBack')}</Title>

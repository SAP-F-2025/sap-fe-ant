		...
		<Space direction="vertical" size="large" style={{ width: '100%' }}>
			...
			>
				<Card title={t('assessmentForm.basicInfo.title')} style={{ marginBottom: 16 }}>
					<Row gutter={16}>
						<Col xs={24}>
							<Form.Item
								...
								name="title"
								rules={[
									{ required: true, message: t('assessmentForm.basicInfo.titleRequired') },
									{ max: 200, message: t('assessmentForm.basicInfo.titleMaxLength') },
								]}
							>
								<Input placeholder={t('assessmentForm.basicInfo.titlePlaceholder')} size="large" />
							</Form.Item>
						</Col>
						<Col xs={24}>
							<Form.Item
								...
								name="description"
								rules={[
									{ max: 1000, message: t('assessmentForm.basicInfo.descriptionMaxLength') },
								]}
							>
								<TextArea
									rows={4}
									placeholder={t('assessmentForm.basicInfo.descriptionPlaceholder')}
									showCount
									maxLength={1000}
								/>
							</Form.Item>
					...
					<Row gutter={16}>
						<Col xs={24} sm={12} lg={6}>
							<Form.Item
								...
								name="duration"
								rules={[
									{ required: true, message: t('assessmentForm.basicInfo.durationRequired') },
								]}
							>
								<InputNumber
									min={5}
						...
						<Col xs={24} sm={12} lg={6}>
							<Form.Item
								...
								name="passing_score"
								rules={[
									{ required: true, message: t('assessmentForm.basicInfo.passingScoreRequired') },
								]}
							>
								<InputNumber
									min={0}
					...
					<Row gutter={16}>
						<Col xs={24} sm={12}>
							<Form.Item label={t('assessmentForm.basicInfo.dueDate')} name="due_date">
								<DatePicker
									showTime
				...
				</Card><Card title={t('assessmentForm.displaySettings.title')} style={{ marginBottom: 16 }}>
					<Row gutter={[16, 16]}>
				...
				</Card><Card title={t('assessmentForm.proctoring.title')} style={{ marginBottom: 16 }}>
					<Row gutter={[16, 16]}>
						<Col xs={24} sm={12} lg={8}>
							<Form.Item

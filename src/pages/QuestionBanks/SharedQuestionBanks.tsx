			...
			render: (text, record) => (
				<Space direction="vertical" size={0}>
					<Space>
						...
						<Tooltip title={record.is_public ? t('sharedQuestionBanks.public') : t('sharedQuestionBanks.private')}>
							{record.is_public ? (
				...
				<Col>
					<Space direction="vertical" size={4}>
						<Title level={2} style={{ margin: 0, fontWeight: 600 }}>
							<ShareAltOutlined style={{ marginRight: 8 }} /> {t('sharedQuestionBanks.title')}
						</Title>
